...
public class ZipFolder {
    ...
    public String zip(final String path) throws IOException {
        ...
        try (ZipOutputStream zos = new ZipOutputStream(new FileOutputStream(zipFileName))) {
            String[] excludePattern = properties.getValue("fortify.exclude.pattern").split("\\|");

            String excludePatternEnvVar = EnvironmentVariable.getOptionalVariable("EXCLUDE_PATTERN");
            ...
            Files.walkFileTree(source, new SimpleFileVisitor<>() {
                ...
                public FileVisitResult visitFile(Path file, BasicFileAttributes attributes) {
                    ...
                    try (FileInputStream fis = new FileInputStream(file.toFile())) {
                        ...
                        if (!excludeFile(file.toString(), finalExcludePattern) && !targetFile.toString().contains(zipFileName)) {
